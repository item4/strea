...
Revision ID: c3b5d97707c4
Revises: 
Create Date: 2017-11-07 23:21:43.833458
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('type', sqlalchemy_utils.types.choice.ChoiceType(
            ScoutType, impl=sa.Integer()), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('cost_type', sqlalchemy_utils.types.choice.ChoiceType(
            CostType, impl=sa.Integer()), nullable=False),
